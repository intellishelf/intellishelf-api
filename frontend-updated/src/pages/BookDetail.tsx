...
import { ArrowLeft, BookOpen, Calendar, Trash2, Edit, Save, X, Upload, XCircle } from "lucide-react";
              ...
              <div className="aspect-[2/3] relative group">
                ...
                {isEditing && !coverPreview && (
                  <button
                    ...
                    className="absolute inset-0 flex items-center justify-center bg-background/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity"
                  >
                    <div className="text-center">
                      <Upload className="w-8 h-8 mx-auto mb-2 text-foreground" />
                      <p className="text-sm text-foreground">Upload Cover</p>
                    </div>
                  </button>
                )}
              </div>
