## Project Overview
Intellishelf is a comprehensive, open-source digital bookshelf management application (similar to Libib) powered by AI, and built on .NET 9 backend, plus a React frontend.
